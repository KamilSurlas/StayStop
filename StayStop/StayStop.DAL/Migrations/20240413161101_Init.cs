    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ManagedHotelsHotelId = table.Column<int>(type: "int", nullable: false),
                    ManagersUserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelUser", x => new { x.ManagedHotelsHotelId, x.ManagersUserId });
                    table.ForeignKey(
                        name: "FK_HotelUser_Hotels_ManagedHotelsHotelId",
                        column: x => x.ManagedHotelsHotelId,
                        principalTable: "Hotels",
                        principalColumn: "HotelId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserOpinion = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReservationPositionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReservationId = table.Column<int>(type: "int", nullable: false),
                    RoomId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationPositions", x => x.ReservationPositionId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationPositions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationPositions_RoomId",
                table: "ReservationPositions",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationPositions_UserId",
                table: "ReservationPositions",
                column: "UserId");
